...
# count = len(oss.listdir("C:\Users\kumar\Downloads\Sign-Language-To-Text-and-Speech-\Sign-Language-To-Text-and-Speech-Conversion-1\AtoZ_3.1\A"))
count = len(oss.listdir(r"C:\Users\kumar\Downloads\Sign-Language-To-Text-and-Speech-\Sign-Language-To-Text-and-Speech-Conversion-1\AtoZ_3.1\A"))
...
cv2.imwrite(r"C:\Users\kumar\Downloads\Sign-Language-To-Text-and-Speech-\Sign-Language-To-Text-and-Speech-Conversion-1\white.jpg",white)
...
while True:
    try:
        ...
        white = cv2.imread(r"C:\Users\kumar\Downloads\Sign-Language-To-Text-and-Speech-\Sign-Language-To-Text-and-Speech-Conversion-1\white.jpg")
        ...
        if hands and isinstance(hands[0], dict):
            ...
            x, y, w, h = hand['bbox']
        # else:
        #      print("No hands detected or unexpected data format.")
...
#             print("Flag toggled:", flag)  # Debug output

#         print("=====", flag)  # This will show the flag's status in each loop iteration

#         # Save images if flag is True
#         if flag:
#             if suv == 180:
#                 flag = False
#             if step % 3 == 0:
#                 cv2.imwrite("D:\\sign2text_dataset_3.0\\AtoZ_3.1\\" + c_dir + "\\" + str(count) + ".jpg", skeleton1)
#                 count += 1
#                 suv += 1
#             step += 1
